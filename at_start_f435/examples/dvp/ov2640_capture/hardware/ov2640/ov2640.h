...
#define OV2640_RST_HIGH  gpio_bits_set(GPIOC, GPIO_PINS_3);
#define OV2640_RST_LOW   gpio_bits_reset(GPIOC, GPIO_PINS_3);
#define OV2640_PWRON_HIGH  gpio_bits_set(GPIOC, GPIO_PINS_1);
